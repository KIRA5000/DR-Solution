...
//
int __cdecl vshadow_wmain(vector<wstring>& arguments, TCBK cbk)
{
    ...
    try
    {
        ...
        return obj.MainRoutine(arguments, cbk);
    }
    catch(bad_alloc ex)
    {
...
//
int CommandLineParser::MainRoutine(vector<wstring> arguments, TCBK cbk)
{
    m_vssClient.SetCallback(cbk);
